...
export const demoAnalysis: Analysis = {
  ...
  strengths: [
    ...
    },
    {
      ...
      detail:
        "Python, REST API design and Git appear consistently across resume, projects and public repositories.",
    ...
    },
    {
      ...
      detail:
        "Recent commits in Python and SQL repositories signal current, active practice rather than dormant coursework.",
      source: "GitHub",
    },
    {
      id: "s4",
      ...
      detail:
        "No unexplained gaps, and the degree is stated plainly with graduation year — this reduces recruiter friction.",
      source: "Resume",
    },
  ],
  weaknesses: [
    ...
    },
    {
      ...
      howToFix:
        "Rewrite each project intro using the Problem → Your role → Stack → Result structure on the Portfolio page.",
    },
    {
      id: "w3",
      severity: "high",
      ...
      whyItMatters:
        "It appears in your skills list with no project or repository evidence behind it, which is a common screening filter.",
      howToFix:
        "Add one project that shows real query work: schema design, joins, indexing, and a short note on a query you optimised.",
    },
    {
      id: "w4",
      ...
      whyItMatters:
        "The README is often the only thing a reviewer reads. Weak documentation makes good code look unfinished.",
      howToFix:
        "Add a short README per repo: what it does, how to run it, architecture in 3 bullets, and a screenshot or sample output.",
    },
    {
      id: "w5",
      severity: "optional",
      ...
      whyItMatters:
        "Passive phrasing dilutes ownership and wastes the highest-attention words in each line.",
      howToFix:
        "Start bullets with concrete verbs: built, designed, migrated, automated, reduced, shipped.",
    },
  ],
  resume: {
    score: 82,
    ...
    signals: [
      {
        label: "Structure",
        value: 88,
        note: "Clear sections, consistent dates, single column — parses reliably.",
      },
      {
        label: "Relevance",
        value: 84,
        note: "Experience and projects map to the target role's core responsibilities.",
      },
      {
        label: "Measurable impact",
        value: 52,
        note: "Only 2 of 14 bullets contain a quantified outcome.",
      },
      { label: "Action verbs", value: 70, note: "Mostly strong, with a few passive openers." },
      {
        label: "Keyword alignment",
        value: 76,
        note: "Covers most required keywords; several preferred ones are absent.",
      },
      {
        label: "ATS compatibility signals",
        value: 86,
        note: "No tables, images or multi-column layout detected in the text.",
      },
    ],
    bulletReviews: [
      {
        ...
        problem:
          "Passive opener, no scale, no outcome. A reviewer can't tell whether this was one endpoint or twenty.",
        suggestion:
      ...
      },
      {
        ...
        suggestion:
          "Name your slice: 'Owned authentication and the API layer (Node.js) for a 4-person project'.",
      },
    ],
    ...
    signals: [
      {
        ...
        value: 78,
        note: "Projects go beyond tutorials and solve a stated problem.",
      },
      {
        label: "Description clarity",
        value: 55,
        note: "Feature lists dominate; context and outcomes are missing.",
      },
      {
        label: "Technical depth shown",
        value: 72,
        note: "Architecture decisions are implied but rarely explained.",
      },
      {
        label: "Evidence (demo / code links)",
        value: 64,
        note: "Two projects lack a live demo or a linked repository.",
      },
      {
        label: "Recruiter readability",
        value: 60,
        note: "Requires reading the full page to understand what you built.",
      },
    ],
    projects: [
      {
        ...
        recommendation:
          "Add one line on what you owned and one line on the outcome (users, records processed, or latency).",
      },
      {
        id: "p2",
        ...
        recommendation:
          "Link the repository and add a 3-bullet architecture note so a reviewer can judge technical depth quickly.",
      },
      {
        id: "p3",
        ...
        recommendation:
          "Show a before/after sample output — it makes the value obvious without running the code.",
      },
    ],
    descriptionTemplate: [
  ...
  github: {
    ...
    highlights: [
      {
        name: "expense-insights-api",
        detail: "Cleanest structure of your public repos; tests present but partial.",
      },
      {
        name: "data-cleaning-toolkit",
        detail: "Practical utility library — good evidence of reusable code habits.",
      },
      {
        name: "campus-events",
        detail: "Largest project, but the README doesn't explain how to run it.",
      },
    ],
    qualitySignals: [
      {
        ...
        status: "warn",
        note: "Present in 9 of 14 repos; thin in two of your strongest.",
      },
      { label: "Setup instructions", status: "bad", note: "Missing on the two largest projects." },
      {
        label: "Commit consistency",
        status: "good",
        note: "Regular commits rather than a single bulk upload.",
      },
      { label: "Tests visible", status: "warn", note: "Test files exist in one repository only." },
      {
        label: "Licence / metadata",
        status: "warn",
        note: "Most repositories have no licence or topics set.",
      },
    ],
  },
  jobMatch: {
    ...
    evidence: [
      {
        ...
        level: "strong",
        required: true,
        sources: ["Resume", "Projects", "GitHub"],
        note: "Primary language across recent work.",
      },
      {
        skill: "REST APIs",
        level: "strong",
        required: true,
        sources: ["Resume", "Project: Expense Insights API"],
        note: "Endpoint design described and code is public.",
      },
      {
        skill: "Git",
        level: "strong",
        required: true,
        sources: ["GitHub"],
        note: "Consistent commit history and branching.",
      },
      {
        skill: "SQL",
        level: "partial",
        required: true,
        sources: ["Skills list"],
        note: "Listed as a skill, but no project or repository shows query or schema work.",
      },
      {
        skill: "Testing",
        level: "partial",
        required: true,
        sources: ["GitHub"],
        note: "Test files in one repository only; not mentioned on the resume.",
      },
      {
        skill: "AWS",
        level: "missing",
        required: false,
        sources: [],
        note: "No deployment or cloud evidence found in the provided sources.",
      },
      {
        skill: "Docker",
        level: "missing",
        required: false,
        sources: [],
        note: "No Dockerfile or containerisation mention detected.",
      },
      {
        skill: "CI/CD",
        level: "missing",
        required: false,
        sources: [],
        note: "No workflow configuration found in public repositories.",
      },
      {
        skill: "React",
        level: "partial",
        required: false,
        sources: ["Project: Campus Events Platform"],
        note: "Used in a team project; your specific contribution is unclear.",
      },
    ],
  },
  skillGaps: [
    {
      ...
      action:
        "Build one project with a real schema: 3+ related tables, joins, indexes. Write a short note on one query you optimised.",
    },
    {
      ...
      action:
        "Add unit tests to your strongest API project and mention coverage of the critical paths on your resume.",
    },
    {
      ...
      action:
        "Deploy one existing project to a managed service and document the setup in the README.",
    },
    {
      skill: "CI/CD",
      level: "missing",
    ...
    },
    {
      ...
      level: "missing",
      priority: "optional",
      why: "Preferred, not required. Useful once deployment is in place.",
      action: "Containerise one project and document the run command.",
    },
    {
      skill: "Python",
      level: "strong",
      priority: "optional",
      why: "Already well evidenced across sources.",
      action: "Keep depth visible: highlight one non-trivial design decision on your resume.",
    },
    {
      skill: "REST API design",
      level: "strong",
      priority: "optional",
      why: "Clearly demonstrated with public code.",
      action: "Add a short API design note to your best repository.",
    },
  ],
  improvementPlan: [
    {
      ...
      reason:
        "Impact is the weakest resume signal at 52/100 and the first thing screeners look for.",
      action:
        "Use the rewrite suggestions on the Resume page. Use real numbers only — if unavailable, state scope instead.",
    },
    {
      id: "r2",
    ...
    },
    {
      ...
      action:
        "Design a 3+ table schema, write analytical queries, document one optimisation with before/after timings.",
    },
    {
      id: "r5",
    ...
    },
    {
      ...
      action:
        "Deploy to a managed service, add the live URL to your portfolio and describe the architecture.",
    },
    {
      id: "r7",
