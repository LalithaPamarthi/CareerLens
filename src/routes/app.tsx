...
function AppLayout() {
  ...
  return (
    <div className="min-h-dvh bg-background">
      ...
      {mobileNavOpen ? (
        <div className="sticky top-[57px] z-30 border-b border-border bg-card px-4 py-3 lg:hidden">
          {nav}
        </div>
      ) : null}
            ...
            {analysis?.isDemo ? (
              <div className="mb-5 flex flex-wrap items-center gap-2 rounded-xl border border-primary/25 bg-accent/60 px-4 py-2.5 text-sm">
                ...
                <span className="text-accent-foreground">
                  You're viewing a sample candidate profile and target job — not real analysis of
                  your data.
                </span>
                <Link
                  to="/analyze"
