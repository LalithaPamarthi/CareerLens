...
export const Route = createFileRoute("/app/job-match")({
  head: () => ({
    meta: [
      { title: "Target job evidence — CareerLens" },
      {
        name: "description",
        content:
          "Compare every target-job requirement with evidence from your resume, portfolio, and GitHub.",
      },
      { property: "og:title", content: "Target job evidence — CareerLens" },
      {
        property: "og:description",
        content: "See strong, partial, and missing evidence for the role you want.",
      },
    ...
    <div className="space-y-8">
      ...
      <section className="space-y-4">
        <div>
          ...
          <h2 className="mt-1 text-lg font-semibold">Evidence Gaps for This Role</h2>
          <p className="mt-1 text-sm text-muted-foreground">
            Focus first on required skills with missing or single-source evidence.
          </p>
        </div>
        <EvidenceTriangulation
          evidence={jobMatch.evidence.filter((item) => item.level !== "strong")}
