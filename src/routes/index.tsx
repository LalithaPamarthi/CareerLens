...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      {
        property: "og:title",
        content: "CareerLens — Don't just tell recruiters what you can do. Prove it.",
      },
      {
      ...
      <main>
          ...
          <div className="mx-auto grid max-w-6xl items-center gap-12 px-4 py-16 sm:px-6 lg:grid-cols-[1.05fr_.95fr] lg:py-24">
            <div>
              <span className="inline-flex items-center gap-1.5 rounded-full border border-primary/25 bg-card px-3 py-1 text-xs font-medium text-primary">
                <ShieldCheck className="size-3.5" /> AI-powered career readiness verification
              </span>
              ...
              <p className="mt-5 max-w-xl text-base leading-relaxed text-muted-foreground">
                CareerLens analyzes your Resume, Portfolio, GitHub, and target job to identify what
                your profile proves, where evidence is missing, and what you should improve next.
              </p>
              ...
              <div className="flex items-start gap-5">
                ...
                <div className="min-w-0 pt-2">
                  ...
                  <p className="mt-1 text-xs leading-relaxed text-muted-foreground">
                    Strong engineering fundamentals, but your impact is under-quantified and two
                    required skills lack evidence.
                  </p>
                </div>
              </div>
                ...
                {SCORES.map((s) => (
                  <div key={s.label}>
                    ...
                    <div className="mt-1.5 h-1 overflow-hidden rounded-full bg-muted">
                      <div
                        className={`h-full rounded-full transition-[width] duration-700 ${scoreBarColor(s.value)}`}
                        style={{ width: `${s.value}%` }}
                      />
                    </div>
                  </div>
              ...
              <div className="mt-6 space-y-2.5 rounded-lg border border-border bg-surface-muted p-3">
                ...
                <div className="flex items-start gap-2.5 border-t border-border pt-2.5">
                  ...
                  <div className="min-w-0">
                    ...
                    <p className="mt-1.5 text-xs leading-relaxed text-muted-foreground">
                      Three of seven required skills are supported only by weak claims. Rewrite the
                      two resume bullets first.
                    </p>
                  </div>
                </div>
              </div>
        ...
        <section className="mx-auto max-w-6xl px-4 py-16 sm:px-6 lg:py-20">
          ...
          <p className="mt-3 max-w-2xl text-sm leading-relaxed text-muted-foreground">
            CareerLens connects each skill claim to evidence, exposes the gap, and turns it into a
        ...
        <section className="mx-auto max-w-3xl px-4 py-20 text-center sm:px-6">
          ...
          <p className="mx-auto mt-3 max-w-xl text-sm leading-relaxed text-muted-foreground">
            Two minutes of pasting, and you get the feedback most people never hear after a
            rejection.
          </p>
