...
export const Route = createFileRoute("/app/portfolio")({
  head: () => ({
    meta: [
      { title: "Portfolio evidence review — CareerLens" },
      {
        name: "description",
        content: "See what your portfolio projects prove and which evidence recruiters still need.",
      },
      { property: "og:title", content: "Portfolio evidence review — CareerLens" },
      {
        property: "og:description",
        content: "Review project evidence, missing context, and concrete improvement actions.",
      },
      ...
      <section className="space-y-3">
        ...
        {portfolio.projects.length === 0 ? (
          <p className="surface-card p-4 text-sm text-muted-foreground">
            No individual project descriptions were detected. Paste one short paragraph per project
            for a per-project review.
          </p>
        ) : (
